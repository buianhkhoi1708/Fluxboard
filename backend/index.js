...
router.use('/departments', require('./src/modules/department/routes/department.routes'));
router.use('/teams', require('./src/modules/team/routes/team.routes'));
router.use('/organizations', require('./src/modules/organization/routes/organization.routes'));

// Lưu ý: Bạn có 2 route cùng trỏ vào '/projects', hãy gộp chúng lại ở cấp độ router bên trong nếu cần
router.use('/projects', require('./src/modules/project/routes/project.routes'));
router.use('/projects', require('./src/modules/projectMember/routes/projectMember.routes'));
...
router.use('/activities', require('./src/modules/activity/routes/activity.routes'));
router.use('/dashboard', require('./src/modules/dashboard/routes/dashboard.routes'));
router.use('/notifications', require('./src/modules/notification/routes/notification.routes'));
router.use('/deadlines', require('./src/modules/deadline/routes/deadline.routes'));
