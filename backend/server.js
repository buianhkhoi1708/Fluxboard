...
// =========================================================
// 1. BẮT LỖI TOÀN CỤC (TRƯỚC KHI KHỞI TẠO APP)
// =========================================================
...
// =========================================================
// 2. KHỞI TẠO SERVER & SOCKET
// =========================================================
const server = http.createServer(app);
const io = socketConfig.init(server);
app.set('io', io); // Gắn io vào app để dùng trong Controller (req.app.get('io'))

// =========================================================
// 3. HÀM KHỞI ĐỘNG HỆ THỐNG ĐỒNG BỘ
// =========================================================
const startServer = async () => {
    try {
        // A. Kết nối Database trước tiên
        await connectDB();
        
        // B. Chạy Seed Data (Đảm bảo DB đã sẵn sàng)
        await seedRbac();
        console.log('✅ RBAC Seeding completed.');
        await seedData();
        console.log('✅ User Seeding completed.');

        // C. Import Listeners & Cron Jobs sau khi DB đã kết nối
