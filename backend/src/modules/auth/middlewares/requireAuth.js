...
const updateSessionActivity = async ({ token, userId, req }) => {
...
module.exports = (req, res, next) => {
  ...
  try {
    ...
    req.user = {
      ...
      user_id: userId,
      role_name:
        decoded.role_name || decoded.role_code || decoded.system_role || null,
      role_code:
        decoded.role_code || decoded.role_name || decoded.system_role || null,
      system_role:
        decoded.system_role || decoded.role_name || decoded.role_code || null,
    };
