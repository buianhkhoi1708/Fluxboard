  ...
  try {
    ...
    const permissionsData = [
      ...
      },
      {
        ...
        scope: Scopes.SYSTEM,
        description: "Xóa/Khóa tài khoản",
      },
      {
      ...
      {
        resource: Resources.PROJECT,
        action: Actions.MANAGE_MEMBERS,
        scope: Scopes.PROJECT,
        description: "Quản lý thành viên dự án",
      },

      {
        resource: Resources.BOARD,
        action: Actions.CREATE,
        scope: Scopes.PROJECT,
      ...
      },
      {
        ...
        action: Actions.READ,
        scope: Scopes.PROJECT,
        description: "Xem Bảng",
      },
      {
        resource: Resources.BOARD,
        action: Actions.UPDATE,
        scope: Scopes.PROJECT,
        description: "Sửa Bảng",
      },
      {
        resource: Resources.BOARD,
        action: Actions.DELETE,
...

      {
        ...
        action: Actions.CREATE,
        scope: Scopes.PROJECT,
        description: "Tạo Thẻ công việc",
      },
      {
        resource: Resources.TASK,
        action: Actions.READ,
        scope: Scopes.PROJECT,
        description: "Xem Thẻ công việc",
      },
      {
        resource: Resources.TASK,
        action: Actions.UPDATE,
        scope: Scopes.PROJECT,
        description: "Sửa & Di chuyển Thẻ",
      },
      {
        resource: Resources.TASK,
        action: Actions.DELETE,
        scope: Scopes.PROJECT,
        description: "Xóa Thẻ công việc",
      },
    ...
    const getPerms = (resource, actions, scope) =>
      actions.map((a) => savedPermissions[`${resource}_${a}_${scope}`]);
    ...
    const rolesData = [
      // ============ CẤP HỆ THỐNG (SYSTEM SCOPE) ============
      {
        name: "SYSTEM_ADMIN",
        scope: Scopes.SYSTEM,
        description: "Toàn quyền kiểm soát hệ thống",
      ...
      },
      {
        ...
        permission_ids: [
          savedPermissions[
            `${Resources.PROJECT}_${Actions.CREATE}_${Scopes.SYSTEM}`
          ],
          ...getPerms(
            Resources.USER,
      ...
      },
      {
        name: "MANAGER",
        scope: Scopes.SYSTEM,
        description: "Quản lý vận hành (Tạo Project, Team)",
        permission_ids: [
          savedPermissions[
            `${Resources.PROJECT}_${Actions.CREATE}_${Scopes.SYSTEM}`
          ],
      ...
      },
      {
        name: "EMPLOYEE",
        scope: Scopes.SYSTEM,
        description: "Nhân viên công ty (Mặc định)",
        permission_ids: [
          ...getPerms(Resources.USER, [Actions.READ], Scopes.SYSTEM),
      ...
      // ============ CẤP DỰ ÁN (PROJECT SCOPE) ============
      {
        name: "PROJECT_ADMIN",
        scope: Scopes.PROJECT,
        description: "Quản trị viên dự án (Full quyền trong Project)",
        permission_ids: Object.values(savedPermissions).filter((id) => {
          const p = Object.keys(savedPermissions).find(
            (key) => savedPermissions[key] === id,
          );
      ...
      },
      {
        name: "PM",
        scope: Scopes.PROJECT,
        description: "Quản lý dự án (Quản lý Bảng, Task, Thành viên)",
        permission_ids: [
          ...ALL_PROJECT_READ,
          ...getPerms(
            Resources.PROJECT,
            [Actions.UPDATE, Actions.MANAGE_MEMBERS],
            Scopes.PROJECT,
          ),
          ...getPerms(
            Resources.BOARD,
      ...
      },
      {
        name: "LEAD",
        scope: Scopes.PROJECT,
        description: "Trưởng nhóm (Quản lý Task, không quản lý Bảng)",
        permission_ids: [
          ...ALL_PROJECT_READ,
          ...getPerms(
            Resources.TASK,
      ...
      },
      {
        name: "MEMBER",
        scope: Scopes.PROJECT,
        description: "Thành viên thực thi (Tạo/Sửa Task, Comment)",
        permission_ids: [
          ...ALL_PROJECT_READ,
      ...
      },
      {
        name: "VIEWER",
        scope: Scopes.PROJECT,
        description: "Khách xem (Chỉ đọc, không thao tác)",
        permission_ids: [...ALL_PROJECT_READ],
      },
    ];
...
const runSeed = async () => {
  try {
    const dbUri =
      process.env.MONGODB_URI || "mongodb://localhost:27017/fluxboard";
